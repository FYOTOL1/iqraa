...
import { search } from "../../redux/reducers/SuggestionsSlice";
...
export default function Header() {
  ...
  return (
    <div className="flex items-center justify-between gap-2 w-full py-1 px-1 md:px-2 lg:px-3 bg-white shadow-md rounded-md outline outline-1 outline-gray-100 text-[8px] sm:text-[12px] md:text-sm lg:text-lg overflow-hidden">
